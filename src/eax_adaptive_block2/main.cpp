...
int main(int argc, char* argv[])
{
    ...
    mpi::ArgumentSpec merge_range_spec(args.merge_range);
    merge_range_spec.add_argument_name("--merge-range");
    merge_range_spec.set_description("--merge-range <number> \t:Merge range for Adaptive Range Merger (default: 20).");
    ...
    cache_dir_spec.set_description("--cache-dir <directory> \t:Directory for caching initial population files (default: current directory).");
